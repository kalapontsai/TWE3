...
function twe_wysiwyg($type, $lang, $langID = '') {
...
$media_path = '&Type=Media';
	...
	switch($type) {
                ...
                case 'products_description':
                        $val ='var oFCKeditor = new FCKeditor( \'products_description_'.$langID.'\', \'100%\', \'300\'  ) ;
                        	   oFCKeditor.BasePath = "'.$path.'" ;
                        	   oFCKeditor.Config["LinkBrowserURL"] = "'.$filemanager.$file_path.'" ;
                        	   oFCKeditor.Config["ImageBrowserURL"] = "'.$filemanager.$image_path.'" ;
							   oFCKeditor.Config["FlashBrowserURL"] = "'.$filemanager.$flash_path.'" ;
                ...
                case 'products_short_description':
                        $val ='var oFCKeditor = new FCKeditor( \'products_short_description_'.$langID.'\', \'100%\', \'200\'  ) ;
                        	   oFCKeditor.BasePath = "'.$path.'" ;
                        	   oFCKeditor.Config["LinkBrowserURL"] = "'.$filemanager.$file_path.'" ;
                        	   oFCKeditor.Config["ImageBrowserURL"] = "'.$filemanager.$image_path.'" ;
							   oFCKeditor.Config["FlashBrowserURL"] = "'.$filemanager.$flash_path.'" ;
                ...
                case 'gv_mail':
                        ...
                        break;
						// WYSIWYG editorlayout textarea named message
                case 'layout':
                        $val ='<script type="text/javascript" src="'.$js_src.'"></script>
                        	   <script type="text/javascript">
                        	   		window.onload = function()
                        	   			{
                        	   				var oFCKeditor = new FCKeditor( \'layout_box_text\', \'700\', \'400\' ) ;
                        	   				oFCKeditor.BasePath = "'.$path.'" ;
                        	   				oFCKeditor.Config["LinkBrowserURL"] = "'.$filemanager.$file_path.'" ;
                        	   				oFCKeditor.Config["ImageBrowserURL"] = "'.$filemanager.$image_path.'" ;
											oFCKeditor.Config["FlashBrowserURL"] = "'.$filemanager.$flash_path.'" ;
