<?php
/* -----------------------------------------------------------------------------------------
   $Id: twe_draw_box_content_bullet.inc.php,v 1.1 2003/09/06 21:47:50 oldpa   Exp $   
   ...
   (c) 2003	 nextcommerce (twe_draw_box_content_bullet.inc.php,v 1.3 2003/08/13); www.nextcommerce.org
   (c) 2003	 xt-commerce  www.xt-commerce.com

   Released under the GNU General Public License 
   ---------------------------------------------------------------------------------------*/
   
function twe_draw_box_content_bullet($bullet_text, $bullet_link = '') {
    global $page_file;
