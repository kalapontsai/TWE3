...
if($content_data->RecordCount() > 0){					
 ...
 $content_string .= '<img src="templates/'.CURRENT_TEMPLATE.'/img/icon_arrow.gif"> <a href="' . twe_href_link(FILENAME_CONTENT,'coID='.$content_data->fields['content_group']) . '">' . $content_data->fields['content_title'] . '</a><br>';
...
$smarty->assign('information',$box_information);
	 	}
	} else {
		$box_information = $box_smarty->fetch(CURRENT_TEMPLATE.'/boxes/box_information.html', $cache_id);
$smarty->assign('information',$box_information);
