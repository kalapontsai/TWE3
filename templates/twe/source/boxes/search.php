...
$box_content='';
  ...
  require_once(DIR_FS_INC . 'twe_hide_session_id.inc.php');
    ...
    $box_smarty->assign('FORM_ACTION',twe_draw_form('quick_find', twe_href_link(FILENAME_ADVANCED_SEARCH_RESULT, '', 'SSL', false), 'get').twe_hide_session_id());
    $box_smarty->assign('INPUT_SEARCH',twe_draw_input_field('keywords', ENTRY_PLEASE, 'maxlength="30"  onFocus="clearText(this)"'));    $box_smarty->assign('BUTTON_SUBMIT',twe_image_submit('button_add_quick.gif', BOX_HEADING_SEARCH).'</form>');
    $box_smarty->assign('LINK_ADVANCED',twe_href_link(FILENAME_ADVANCED_SEARCH,'','SSL'));
