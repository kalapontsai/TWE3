...
define('HEADING_TITLE', '資料庫總管');

define('TABLE_HEADING_TITLE', '備份資料庫檔名');
...
define('TEXT_INFO_UNPACK', '<br><br>(從壓縮檔解壓縮之 後)');
define('TEXT_INFO_RESTORE', '資料庫回復時請勿中斷<br><br>檔案越 大，則需要更多處理時間!<br><br>如果可以,請使用 mysql client.<br><br>例如：<br><br><b>mysql -h' . DB_SERVER . ' -u' . DB_SERVER_USERNAME . ' -p ' . DB_DATABASE . ' < %s </b> %s');
...
define('SUCCESS_BACKUP_UPLOAD', '成功:資料上傳完成.');

define('TABLE_HEADING_TITLE_SITE', '備份所有網站程式(只提供下載):');
define('BUTTON_BACKUP', '備 份');
define('BUTTON_UPLOAD', '上 傳');
define('TEXT_COMPLETE_INSERTS','使用完整新增指令');
