<?php
/* --------------------------------------------------------------
   $Id: banner_manager.php,v 1.1 2003/12/19 13:19:08 oldpa   Exp $   
...
define('HEADING_TITLE', '橫幅廣告總管');

define('TABLE_HEADING_BANNERS', '廣告');
define('TABLE_HEADING_GROUPS', '群組');
define('TABLE_HEADING_STATISTICS', '瀏覽次數 / 擊點次數');
...
define('SUCCESS_?BANNER_UPDATED', '完成：廣告已經更新');
...
define('ERROR_GRAPHS_DIRECTORY_DOES_NOT_EXIST', '錯誤：Graphs 資料夾不存在，請新增 \'images\graphs\'');
