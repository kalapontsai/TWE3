<?php
/* -----------------------------------------------------------------------------------------
   $Id: coupon_admin.php,v 1.2 2004/04/01 14:19:25 oldpa   Exp $
...
define('TEXT_TO_REDEEM', '您可以在結帳時填入兌換碼,按下兌換鈕,來兌換這個折價券.');
