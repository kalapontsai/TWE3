...
/* -----------------------------------------------------------------------------------------
   ...
   $Id: print_order.php,v 1.0 2011/06/30 ELHOMEO.com   
  ...
  define('TEXT_EXP_TITLE','店名');

  define('TEXT_EXP_NUMBER','店號');

  define('TEXT_EXP_TYPE_0','未定義');

  define('TEXT_EXP_TYPE_1','統一超商');

  define('TEXT_EXP_TYPE_2','全家便利');
