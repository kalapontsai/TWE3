...
define('HEADING_TITLE', '報價單');
define('HEADING_TITLE_SEARCH', '報價單序號：');
define('HEADING_TITLE_STATUS', '狀態：');

define('TABLE_HEADING_COMMENTS', '意見欄');
define('TABLE_HEADING_CUSTOMERS', '客戶');
define('TABLE_HEADING_ORDER_TOTAL', '報價單總計');
define('TABLE_HEADING_DATE_PURCHASED', '報價日期');
...
define('ENTRY_DATE_PURCHASED', '報價日期：');
...
define('TEXT_INFO_HEADING_DELETE_ORDER', '刪除報價單');
define('TEXT_INFO_DELETE_INTRO', '確定要刪除這筆報價單？');
...
define('TEXT_ALL_ORDERS', '所有報價單');
define('TEXT_NO_ORDER_HISTORY', '無報價單紀錄');

define('EMAIL_SEPARATOR', '------------------------------------------------------');
define('EMAIL_TEXT_SUBJECT', STORE_NAME . ' 報價單狀態更新');
define('EMAIL_TEXT_ORDER_NUMBER', '報價單編號：');
define('EMAIL_TEXT_INVOICE_URL', '詳細發票：');
define('EMAIL_TEXT_DATE_ORDERED', '報價單日期：');
define('EMAIL_TEXT_STATUS_UPDATE', '您的報價單已更新為下列狀態' . "\n\n" . '新狀態是： %s' . "\n\n" . '如有任何疑問，請直接回信告訴我們' . "\n");
define('EMAIL_TEXT_COMMENTS_UPDATE', '您的意見如下：' . "\n\n%s\n\n");

define('ERROR_ORDER_DOES_NOT_EXIST', '錯誤：報價單不存在');
define('SUCCESS_ORDER_UPDATED', '完成：報價單已更新完成');
define('WARNING_ORDER_NOT_UPDATED', '注意： 此筆報價單狀態沒有改變，無法更新');
