...
//  define('MODULE_PAYMENT_ATM_TEXT_DESCRIPTION1', '請就近至ATM 自動提款機轉帳，只要簡單輸入幾個數字及金額就可以輕鬆完成繳款:<br>1.輸入密碼<br>2.選擇其他交易或金額<br>3.選擇轉帳<br>4.如非'  . MODULE_PAYMENT_ATM_BANKNAME . ' 之提款機(ATM)，請選擇其他行庫<br>5.輸入銀行代號:' . MODULE_PAYMENT_ATM_BANKCODE . '<br>6.輸入帳號:' . MODULE_PAYMENT_ATM_ACCNUM . '<br>7.輸入轉帳金額<br><br>' . '當您完成繳款手續時，請填寫匯款通知或來信告知您的訂單序號與匯款資料，核對無誤後會立即將您的商品寄出，謝謝您的惠顧。');
//  define('MODULE_PAYMENT_ATM_TEXT_EMAIL_FOOTER', "請就近至ATM 自動提款機轉帳，只要簡單輸入幾個數字及金額就可以輕鬆完成繳款:\n1.輸入密碼\n2.選擇其他交易或金額\n3.選擇轉帳\n4.如非" . MODULE_PAYMENT_ATM_BANKNAME . "之提款機(ATM)，請選擇其他行庫\n5.輸入銀行代號:" . MODULE_PAYMENT_ATM_BANKCODE. "\n6.輸入帳號:" . MODULE_PAYMENT_ATM_ACCNUM . "\n7.輸入轉帳金額\n\n當您完成繳款手續時，請填寫匯款通知或來信告知您的訂單序號與匯款資料，\n核對無誤後會立即將您的商品寄出，謝謝您的惠顧。");
  define('MODULE_PAYMENT_ATM_TEXT_DESCRIPTION1', MODULE_PAYMENT_ATM_BANKNAME . '(代碼:' . MODULE_PAYMENT_ATM_BANKCODE . ')<br>帳戶名稱：李麗玉<br>帳戶號碼：' . MODULE_PAYMENT_ATM_ACCNUM . '<br><br><br>' );
  define('MODULE_PAYMENT_ATM_TEXT_EMAIL_FOOTER', MODULE_PAYMENT_ATM_BANKNAME . '(代碼:'. MODULE_PAYMENT_ATM_BANKCODE. ')\n帳戶名稱：李麗玉\n帳戶號碼：' . MODULE_PAYMENT_ATM_ACCNUM . '\n\n');

// // 用在訂單列印 print_order.php 
  define('MODULE_PAYMENT_ATM_TEXT_DESCRIPTION2',MODULE_PAYMENT_ATM_BANKNAME . '<br>帳戶名稱：李麗玉<br>帳戶號碼：' . MODULE_PAYMENT_ATM_ACCNUM  );
