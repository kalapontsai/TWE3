<?php
/* --------------------------------------------------------------
   $Id: english.php,v 1.14 2004/04/01 14:19:25 oldpa   Exp $   
...
define('BOX_QUOTES_ORDERS','Quotes Admin');
...
define('BOX_CONFIGURATION_8', 'Index Products Options');
...
define('IMAGE_ICON_LAYOUT_RED', 'Set box to here');
...
define('TEXT_DELETE', 'Delete Image');
define('TXT_ALL','All');
define('HEADER_TITLE_EDIT_ATTRIBUTES', 'Edit Attributes');
define('HEADER_TITLE_PRODUCT_ATTRIBUTES_UPDATED', 'Product Attributes Updated');
define('TEXT_PRODUCT_ATTRIBUTES_SELECT', 'Please select a product to edit:');
define('TEXT_PRODUCT_ATTRIBUTES_SELECT_COPY', 'Please select a product to copy attributes from:');
define('TEXT_NO_PRODUCT_ATTRIBUTES_COPY', 'No products to copy attributes from:');
define('TEXT_NO_PRODUCT_ATTRIBUTES', 'You have no products at this time');
define('BOX_NEWS_CATEGORIES', 'News');
define('SUCCESS_LAST_MOD', 'Update Success');
define('BOX_QUOTES_ORDERS', 'Quotes');
define('TABLE_HEADING_PRODUCTS_IMAGE', 'Products Image');
define('ENTRY_TELEPHONE_FAX', 'Fax');
define('BOX_LAYOUT_CONTROLLER','Column Boxes'); 
