...
define('SUCCESS_BACKUP_UPLOAD', 'Success: The database was upload.');

define('TABLE_HEADING_TITLE_SITE', 'This will Back Up ALL files on:');
define('BUTTON_BACKUP', 'Backup Now!');
define('BUTTON_UPLOAD', 'Upload Now!');
