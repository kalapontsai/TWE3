...
/* --------------------------------------------------------------
 ...
 define('TABLE_HEADING_CONTENT_SORT','sort');

 define('TEXT_YES','Yes');
 define('TEXT_NO','No');
 define('TABLE_HEADING_CONTENT_ACTION','Action');
 define('TEXT_DELETE_IMG','Delete');
 ...
 define('TEXT_FILE_DESCRIPTION','<b>Info:</b><br>You also got the opportunity to upload a <b>.htlm</b> or <b>.htm</b> file and display it as shop content.<br> If you select or upload a file, the text in the box will be ignored.<br><br>');
