<?php
/* --------------------------------------------------------------
   $Id: stats_products_viewed.php,v 1.5 2004/02/29 17:05:18 oldpa Exp $   
...
?>
              <tr class="dataTableRow" onmouseover="this.className='dataTableRowOver';this.style.cursor='hand'" onmouseout="this.className='dataTableRow'">
                ...
                <td class="dataTableContent"><?php echo  $products->fields['products_name'] . '(' . $products->fields['name'] . ')'; ?></td>
