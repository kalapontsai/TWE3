...
/* -----------------------------------------------------------------------------------------
  ...
  if ( ($_GET['action'] == 'send_email_to_user') && ($_POST['customers_email_address'] || $_POST['email_to']) && (!$_POST['back_x']) ) {
    ...
    while (!$mail->EOF) {
      ...
      if ($subject='') $subject = EMAIL_GV_SUBJECT;
   ...
   $mail->MoveNext();
    ...
    if ($_POST['email_to']) {
      ...
      twe_php_mail(EMAIL_BILLING_ADDRESS,EMAIL_BILLING_NAME, $_POST['email_to'] , '' , '', EMAIL_BILLING_REPLY_ADDRESS, EMAIL_BILLING_REPLY_ADDRESS_NAME, '', '', $subject, $html_mail , $txt_mail);
...
?>
             ...
             <tr>
              ...
              <tr>
                ...
                <td><?php echo twe_draw_input_field('subject','艾沙順勢糖球屋的禮卷通知'); ?></td>
              </tr>
              <tr>
                <td colspan="2"><?php echo twe_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
              </tr>
