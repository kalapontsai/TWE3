<?php
/* --------------------------------------------------------------
   $Id: language.php,v 1.1 2003/09/06 22:05:29 oldpa   Exp $   
  ...
  class language {
    ...
    function language($lng = '') {
      ...
      $languages= $db->Execute("select languages_id, name, code, image, directory, language_charset from " . TABLE_LANGUAGES . " order by sort_order");
      while (!$languages->EOF) {
