<?php
/* -----------------------------------------------------------------------------------------
   $Id: navigation_history.php,v 1.1 2003/09/06 22:13:53 oldpa   Exp $   
  ...
  class navigationHistory {
    ...
    function debug() {
      ...
      if (sizeof($this->snapshot) > 0) {
        ...
        echo $this->snapshot['mode'] . ' ' . $this->snapshot['page'] . '?' . twe_array_to_string($this->snapshot['get'], array(twe_session_name())) . '<br>';
      }
    }
