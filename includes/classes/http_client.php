<?php
/* -----------------------------------------------------------------------------------------
   $Id: http_client.php,v 1.1 2003/09/06 22:13:53 oldpa   Exp $   
 ...
 **/
    function Connect($host, $port = '') {
      ...
      $this->url['host'] = $host;
      if (twe_not_null($port)) $this->url['port'] = $port;
