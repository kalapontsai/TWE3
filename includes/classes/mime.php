<?php
/* -----------------------------------------------------------------------------------------
   $Id: mime.php,v 1.1 2003/09/06 22:13:53 oldpa   Exp $   
   ...
   (c) 2002-2003 osCommerce(mime.php,v 1.7 2002/11/19); www.oscommerce.com 
   (c) 2003	 nextcommerce (mime.php,v 1.4 2003/08/13); www.nextcommerce.org
...
//      $encoded =& $this->_encoded;
      ...
      if (twe_not_null($this->_subparts)) {
        $boundary = '=_' . md5(uniqid(twe_rand()) . microtime());
