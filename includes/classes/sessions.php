<?php
/* -----------------------------------------------------------------------------------------
   $Id: sessions.php,v 1.1 2003/09/06 22:13:53 oldpa   Exp $   
   ...
   (c) 2002-2003 osCommerce(sessions.php,v 1.14 2003/03/14); www.oscommerce.com 
...
*/
    ...
    if ($session->gc_probability > 0) {
      $randmax = getrandmax();
      $nrand = (int)(100 * twe_rand() / $randmax);
