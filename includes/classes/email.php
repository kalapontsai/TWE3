<?php
/* --------------------------------------------------------------
   $Id: email.php,v 1.1 2003/09/06 22:13:53 oldpa   Exp $   
   ...
   (c) 2002-2003 osCommerce(email.php,v 1.11 2003/05/29); www.oscommerce.com 
   (c) 2003	 nextcommerce (email.php,v 1.8 2003/08/18); www.nextcommerce.org
  ...
  // include functions
  require_once(DIR_FS_INC . 'twe_convert_linefeeds.inc.php');
...
//    function build_message($params = array()) {
    function build_message($params = '') {
      ...
      if (twe_not_null($this->html_images)) {
      ...
      $null = NULL;
      $attachments = ((twe_not_null($this->attachments)) ? true : false);
      $html_images = ((twe_not_null($this->html_images)) ? true : false);
      $html = ((twe_not_null($this->html)) ? true : false);
      $text = ((twe_not_null($this->text)) ? true : false);
...
//          $message =& $this->add_mixed_part();
        ...
        case (($html == true) && ($attachments == false) && ($html_images == false)):
          if (twe_not_null($this->html_text)) {
/* HPDL PHP3 */
