<?php
/* -----------------------------------------------------------------------------------------
   $Id: filenames.php,v 1.5 2004/03/16 20:12:29 oldpa Exp $   
...
// define the filenames used in the project
  ...
  define('FILENAME_NEWS_PRODUCT_LISTING', 'news_product_listing.php'); 
  define('FILENAME_NEWS_PRODUCT_INFO', 'news_product_info.php');
  define('FILENAME_NEWS_METATAGS','news_metatags.php');
  define('FILENAME_PRINT_NEWS_PRODUCT_INFO','print_news_product_info.php');
  define('FILENAME_EDIT_NEWS_PRODUCTS','admin/news_categories.php');
  define('FILENAME_NEWS_NEW_PRODUCTS', 'news_new_products.php');
  define('FILENAME_SPECIALS_CENTER', 'specials_center.php');  
  define('FILENAME_BBFORUM', 'forum/index.php');
  define('FILENAME_PHPBB_PROFILE', 'forum/profile.php'); 
  
  define('FILENAME_EZSHIP_MAP', 'http://map.ezship.com.tw/ezship_map_web.jsp');
  define('FILENAME_EZSHIP', 'admin/ezship.php');
?>